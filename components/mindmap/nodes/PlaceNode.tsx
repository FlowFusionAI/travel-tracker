...
export default function PlaceNode({ data, selected }: NodeProps<MindMapNodeData>) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 border-b border-[#22c55e]/30">
        <span className="text-sm">📍</span>
        <span
          className="text-[9px] text-[#22c55e] truncate"
