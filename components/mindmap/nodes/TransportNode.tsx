...
export default function TransportNode({ data, selected }: NodeProps<MindMapNodeData>) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 border-b border-[#6b7280]/30">
