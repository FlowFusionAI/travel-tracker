...
export default function NoteNode({ data, selected }: NodeProps<MindMapNodeData>) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 px-2 py-1.5 border-b border-[#eab308]/30">
        <span className="text-sm">📝</span>
        <span
          className="text-[9px] text-[#eab308] truncate"
